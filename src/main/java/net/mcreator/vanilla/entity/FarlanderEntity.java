...
package net.mcreator.vanilla.entity;
...
import net.mcreator.vanilla.procedures.FarlanderOnInitialEntitySpawnProcedure;
import net.mcreator.vanilla.item.FarlandsPortalIgniterItem;
import net.mcreator.vanilla.VanillaElements;

import java.util.Random;

@VanillaElements.ModElement.Tag
public class FarlanderEntity extends VanillaElements.ModElement {
	public static EntityType entity = null;
	public FarlanderEntity(VanillaElements instance) {
		super(instance, 5);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(100).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.8f)).build("farlander")
						.setRegistryName("farlander");
		elements.entities.add(() -> entity);
		elements.items
				.add(() -> new SpawnEggItem(entity, -16777216, -3407668, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("farlander"));
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			if (ForgeRegistries.BIOMES.getKey(biome).equals(new ResourceLocation("vanilla:farland")))
				biomeCriteria = true;
			if (!biomeCriteria)
				continue;
		...
		RenderingRegistry.registerEntityRenderingHandler(CustomEntity.class, renderManager -> {
			BipedRenderer customRender = new BipedRenderer(renderManager, new BipedModel(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("vanilla:textures/download.png");
				}
			};
	...
	public static class CustomEntity extends ZombieEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			this.setItemStackToSlot(EquipmentSlotType.OFFHAND, new ItemStack(FarlandsPortalIgniterItem.block, (int) (1)));
		...
		public net.minecraft.util.SoundEvent getAmbientSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.note_block.guitar"));
		}

		@Override
		public net.minecraft.util.SoundEvent getHurtSound(DamageSource ds) {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.note_block.xylophone"));
		}

		@Override
		public net.minecraft.util.SoundEvent getDeathSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("music_disc.strad"));
		}
		...
		public ILivingEntityData onInitialSpawn(IWorld world, DifficultyInstance difficulty, SpawnReason reason, ILivingEntityData livingdata,
			...
			Entity entity = this;
			{
				...
				FarlanderOnInitialEntitySpawnProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
