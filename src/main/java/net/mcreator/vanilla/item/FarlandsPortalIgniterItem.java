...
public class FarlandsPortalIgniterItem extends VanillaElements.ModElement {
	@ObjectHolder("vanilla:farlandsportaligniter")
	public static final Item block = null;
	public FarlandsPortalIgniterItem(VanillaElements instance) {
		super(instance, 4);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(ItemGroup.MISC).maxDamage(1));
			setRegistryName("farlandsportaligniter");
		}
