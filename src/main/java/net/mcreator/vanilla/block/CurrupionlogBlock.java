...
public class CurrupionlogBlock extends VanillaElements.ModElement {
	@ObjectHolder("vanilla:currupionlog")
	public static final Block block = null;
	public CurrupionlogBlock(VanillaElements instance) {
		super(instance, 29);
	}
