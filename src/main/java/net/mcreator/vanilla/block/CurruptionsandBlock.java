...
public class CurruptionsandBlock extends VanillaElements.ModElement {
	@ObjectHolder("vanilla:curruptionsand")
	public static final Block block = null;
	public CurruptionsandBlock(VanillaElements instance) {
		super(instance, 31);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("curruptionsand");
		}
