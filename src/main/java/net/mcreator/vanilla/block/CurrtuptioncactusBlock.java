...
public class CurrtuptioncactusBlock extends VanillaElements.ModElement {
	@ObjectHolder("vanilla:currtuptioncactus")
	public static final Block block = null;
	public CurrtuptioncactusBlock(VanillaElements instance) {
		super(instance, 32);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("currtuptioncactus");
		}
