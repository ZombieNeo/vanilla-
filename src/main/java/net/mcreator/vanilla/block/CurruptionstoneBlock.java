...
public class CurruptionstoneBlock extends VanillaElements.ModElement {
	@ObjectHolder("vanilla:curruptionstone")
	public static final Block block = null;
	public CurruptionstoneBlock(VanillaElements instance) {
		super(instance, 28);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("curruptionstone");
		}
