...
public class CurruptiongrassBlock extends VanillaElements.ModElement {
	@ObjectHolder("vanilla:curruptiongrass")
	public static final Block block = null;
	public CurruptiongrassBlock(VanillaElements instance) {
		super(instance, 26);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("curruptiongrass");
		}
