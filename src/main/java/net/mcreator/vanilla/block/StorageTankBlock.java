...
public class StorageTankBlock extends VanillaElements.ModElement {
	@ObjectHolder("vanilla:storagetank")
	public static final Block block = null;
	@ObjectHolder("vanilla:storagetank")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public StorageTankBlock(VanillaElements instance) {
		super(instance, 22);
	...
	public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
		event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("storagetank"));
	}
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(1f, 10f).lightValue(0));
			setRegistryName("storagetank");
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("storagetank");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Storage Tank");
		}
