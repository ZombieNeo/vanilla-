...
public class CurruptionmossystoneBlock extends VanillaElements.ModElement {
	@ObjectHolder("vanilla:curruptionmossystone")
	public static final Block block = null;
	public CurruptionmossystoneBlock(VanillaElements instance) {
		super(instance, 27);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("curruptionmossystone");
		}
