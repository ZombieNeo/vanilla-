...
public class CurruptionleafsBlock extends VanillaElements.ModElement {
	@ObjectHolder("vanilla:curruptionleafs")
	public static final Block block = null;
	public CurruptionleafsBlock(VanillaElements instance) {
		super(instance, 30);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("curruptionleafs");
		}
