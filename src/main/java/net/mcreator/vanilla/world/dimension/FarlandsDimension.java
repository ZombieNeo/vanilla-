...
package net.mcreator.vanilla.world.dimension;
...
import net.mcreator.vanilla.procedures.FarlandsPlayerEntersDimensionProcedure;
import net.mcreator.vanilla.item.FarlandsItem;
...
public class FarlandsDimension extends VanillaElements.ModElement {
	@ObjectHolder("vanilla:farlands")
	public static final ModDimension dimension = null;
	@ObjectHolder("vanilla:farlands_portal")
	public static final CustomPortalBlock portal = null;
	public static DimensionType type = null;
	private static Biome[] dimensionBiomes;
	public FarlandsDimension(VanillaElements instance) {
		super(instance, 1);
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("farlands"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("vanilla:farlands")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("vanilla:farlands"), dimension, null, true);
		}
		type = DimensionType.byName(new ResourceLocation("vanilla:farlands"));
	}

	@Override
	public void init(FMLCommonSetupEvent event) {
		dimensionBiomes = new Biome[]{ForgeRegistries.BIOMES.getValue(new ResourceLocation("vanilla:farland")),
				ForgeRegistries.BIOMES.getValue(new ResourceLocation("vanilla:snowmega")),};
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new CustomPortalBlock());
		elements.items.add(() -> new FarlandsItem().setRegistryName("farlands"));
	}
	public static class CustomPortalBlock extends NetherPortalBlock {
		public CustomPortalBlock() {
			...
			setRegistryName("farlands_portal");
		}
		...
		if (event.getTo() == type) {
			{
				...
				FarlandsPlayerEntersDimensionProcedure.executeProcedure($_dependencies);
			}
		}
	}
